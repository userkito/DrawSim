...
A drawing simulator to set dots and draw line_screen_coord
on a canvas and know its cartesian coordinates.
...
class DrawSim():
    ...
    #Draw line using Direct Scan Conversion (normal Slope intercept)
    def draw_line1(self):
        if self.dot_count>1:
            line=[]
            line_coord=[]
    ...
    def clear_canvas(self):
        ...
        self.dot_size_box["state"]="disabled"
        self.dot_color=DOT_COLOR
        self.offset=OFFSET
        self.dot_count=0
        self.line_count=0
    ...
    def create_DrawSim_Gui(self):
        ...
        self.set_button("Line 2",self.draw_line2,1198,420,1,10)

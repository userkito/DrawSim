...
class DrawSim():
    ...
    def line(self):
        ...
        t2=self.dot_count-1
        self.removed1_coord.append([x1,y1,t1])
        self.removed1_coord.append([x2,y2,t2])
        return x1,y1,x2,y2
    ...
    def add_line(self,line,line_coord,line_screen_coord):
        ...
        self.removed1.append(self.dots[self.dot_count-2])
        self.removed1.append(self.dots[self.dot_count-1])
        self.canvas.delete(self.removed1[self.cont-2])
        self.canvas.delete(self.removed1[self.cont-1])
        #enable coordinates text box editing
    ...
    def delete_last_dot(self):
        if self.dot_count>0:
            ...
            self.dot_count-=1
            if self.dot_count==0 or self.line_count==0:
                self.cont=0
    ...
    def delete_last_line(self):
        if self.line_count>0:
            ...
            self.line_coord_box["state"]="disabled"
            print("\n")
            print(str(self.removed1_coord[self.cont-2][2]))
            print(str(self.removed1_coord[self.cont-1][2]))
            self.dots.insert(self.removed1_coord[self.cont-2][2],self.dot(self.removed1_coord[self.cont-2][0],self.removed1_coord[self.cont-2][1]))
            self.dots.insert(self.removed1_coord[self.cont-1][2],self.dot(self.removed1_coord[self.cont-1][0],self.removed1_coord[self.cont-1][1]))
            if self.dot_count-self.cont==0:
                self.cont-=2
            if self.line_count==0:
                self.cont=0

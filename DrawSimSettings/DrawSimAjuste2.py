...
class DrawSim():
    ...
    def line(self):
        ...
        #ocultamos punto inicial y final para ver la linea bien
        self.canvas.delete(self.dots[self.dot_count-2])
    ...
    def delete_last_line(self):
        if self.line_count>0:
            ...
            self.line_coord_box["state"]="disabled"
            x=self.dot_count
            #volvemos a pintar los puntos oculos de la linea
            self.dots.insert(x-2-self.cont,self.dot(self.dot_screen_coord[x-2-self.cont][0],self.dot_screen_coord[x-2-self.cont][1]))
            self.dots.insert(x-1-self.cont,self.dot(self.dot_screen_coord[x-1-self.cont][0],self.dot_screen_coord[x-1-self.cont][1]))
            self.cont+=2
            self.r=True
